...
namespace DistrictStatisticsManagement.Api.Controllers
{
    ...
    public class EnterpriseController : ControllerBase
    {
        ...
        public ActionResult GetTop5EnterprisesBySupplyCount()
        {
            var topEnterprises = _repository.GetTop5EnterprisesBySupplyCount();
            var result = topEnterprises.Select(enterprise => new
            {
                enterprise.RegistrationNumber,
                enterprise.Name,
                IndustryType = enterprise.IndustryType.ToString(),
