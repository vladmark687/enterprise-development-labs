...
namespace DistrictStatisticsManagement.Api.Controllers
{
    ...
    public class SupplierController : ControllerBase
    {
        ...
        [HttpGet("{id}/details")]
        public ActionResult<object> GetSupplierDetails(int id)
        {
            var supplier = _repository.GetAllSuppliers().FirstOrDefault(s => s.Id == id);
            ...
            return Ok(new
            {
                ...
                supplier.Address,
                supplier.Phone,
                SuppliesCount = supplier.Supplies?.Count ?? 0,
                TotalSupplyCost = supplier.Supplies?.Sum(s => s.Cost) ?? 0,
                TotalQuantitySupplied = supplier.Supplies?.Sum(s => s.Quantity) ?? 0
            });
        }
        ...
        public IActionResult UpdateSupplier(int id, Supplier supplier)
        {
            ...
            var existingSupplier = _repository.GetSupplierForUpdate(id);
